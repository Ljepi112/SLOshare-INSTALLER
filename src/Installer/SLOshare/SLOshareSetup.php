...
namespace App\Installer\SLOshare;

use App\Installer\BaseInstaller;

class SLOshareSetup extends BaseInstaller
{
    ...
    protected function env()
    {
        ...
        $this->createFromStub(
            [
                ...
                '{{TWITCHCLIENTID}}' => $this->config->app('twitch-id'),
                '{{TWITCHCLIENTSECRET}}' => $this->config->app('twitch-secret'),
    ...
    protected function setup()
    {
       ...
       $this->process([
        ...
        $this->createFromStub([
            ...
            '{{WEBUSER}}' => $web_user,
        ], 'supervisor/app.conf', '/etc/supervisor/conf.d/sloshare.conf');
